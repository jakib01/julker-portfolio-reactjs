                ...
                <div className="resume-item d-flex flex-column ">
                    ...
                    <div className="resume-item d-flex flex-column flex-md-row justify-content-between ">
                        <div className="resume-content">
                            <h3 className="mb-0">The Next Generation Multifunctional Window System</h3>
                            ...
                            <div className="row">
                                <div className="col"><img className="img-fluid" width="80%" src="images/window.jpg"alt=""/>
                                </div>
                                <div className="col">
                                    <iframe width="460" height="285"
                                            src="https://www.youtube.com/embed/EA6hQUu9bXQ?autoplay=0"></iframe>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="resume-item d-flex flex-column flex-md-row justify-content-between mb-5">
                        <div className="resume-content">
                            ...
                            <p>Speech recognition is now an area where a lot of research is being done. Our main
                                goal is
                                to have emotion Detection by voice through the machine for Bangla language.
                                ...
                                have
                                been recorded in the ongoing Bengali language where eight types of emotions can
                                detect.
                                Speech includes neutral, calm, happy, sad, angry, fearful, surprise, and disgust
                                expressions. Every actor has recorded 60 audio clips and each clip has been recorded
                                for
                                eight emotions, with eight different counters each. Total estimates have been made
                                from
                                1200 recordings of 20 people. In this paper, we used the high pass filter to get
                                good
                                results. High pass filter is used to remove noise. Feature extraction is very
                                important
                                for our paper, so we used mel Frequency cepstrum coefficient (MFCC) as feature
                                extraction. We have followed two methods as a feature selection, first, we have used
                                the
                                random forest. We didn’t get very good results from the random forest, Then we used
                                the
                                neural network to achieve good results as our main classifier is a feasible
                                technique
                                for the emotional classification. The results show that the neural network used as a
                    ...
                    <div className="resume-item d-flex flex-column flex-md-row justify-content-between">
                        <div className="resume-content">
                            ...
                            <p>Offline handwritten character recognition is a process where a machine will recognize
                                ...
                                doctor’s
                                handwriting from a prescription. So the selection of a good feature extraction
                                method is
                                the most important factor. Because if we want to achieve high recognition
                                performance
                                with much better accuracy we must have to select good feature extraction method. We
                                want
                                to develop an OCR agent which will detect doctor’s handwriting from prescription.
                                Our
                                main target is building a medicine website where people will upload their
                                prescription
                                image and our agent will detect out the medicine names. So to do that we have to
                                apply
                                various techniques to extract information from images. Image Processing, Machine
